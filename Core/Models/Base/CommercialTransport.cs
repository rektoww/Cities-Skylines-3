...
//
// НУЖНО РЕШИТЬ, ГДЕ И КАК ОПРЕДЕЛЯЕТСЯ МАРШРУТ: В РОДИТЕЛЕ ПО ТИПУ ТРАНСПОРТА ИЛИ В НАСЛЕДНИКЕ
//
...
//
// РЕАЛИЗОВАТЬ СКРЫТИЕ ТРАНСПОРТА НА КАРТЕ ПРИ ПРИБЫТИИ В ПОРТ? ЧЕ? КАК?
//
